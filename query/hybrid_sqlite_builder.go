...
func buildGraphInSQLite(storage *HybridStorage, tree *types.GedcomTree, graph *Graph) error {
	db := storage.SQLite()
...
func processIndividualsForSQLite(tree *types.GedcomTree, graph *Graph, stmtNode, stmtXref *sql.Stmt, now int64) error {
...
func processFamiliesForSQLite(tree *types.GedcomTree, graph *Graph, stmtNode, stmtXref *sql.Stmt, now int64) error {
...
func processNotesForSQLite(tree *types.GedcomTree, graph *Graph, stmtNode, stmtXref *sql.Stmt, now int64) error {
...
func processSourcesForSQLite(tree *types.GedcomTree, graph *Graph, stmtNode, stmtXref *sql.Stmt, now int64) error {
...
func processRepositoriesForSQLite(tree *types.GedcomTree, graph *Graph, stmtNode, stmtXref *sql.Stmt, now int64) error {
...
func processEventsForSQLite(tree *types.GedcomTree, graph *Graph, stmtNode, stmtXref *sql.Stmt, now int64) error {
...
func updateRelationshipFlags(storage *HybridStorage, tree *types.GedcomTree, graph *Graph) error {
	db := storage.SQLite()
