...
func (gd *GedcomDiffer) Compare(tree1, tree2 *types.GedcomTree) (*DiffResult, error) {
	startTime := time.Now()
...
func (gd *GedcomDiffer) buildStatistics(tree *types.GedcomTree) RecordStats {
...
func (gd *GedcomDiffer) countRecords(tree *types.GedcomTree) int {
