...
func (dd *DuplicateDetector) calculateNameSimilarity(indi1, indi2 *types.IndividualRecord) float64 {
	name1 := indi1.GetName()
	name2 := indi2.GetName()
...
func (dd *DuplicateDetector) calculateDateSimilarity(indi1, indi2 *types.IndividualRecord) float64 {
...
func (dd *DuplicateDetector) calculatePlaceSimilarity(indi1, indi2 *types.IndividualRecord) float64 {
...
func (dd *DuplicateDetector) calculateSexSimilarity(indi1, indi2 *types.IndividualRecord) float64 {
...
func dateSimilarity(date1, date2 *types.GedcomDate, tolerance int) float64 {
...
func getDateRange(date *types.GedcomDate, tolerance int) dateRange {
	if date == nil {
	...
	switch date.Type {
	case types.DateTypeExact, types.DateTypeUnknown:
		year := date.Year
		if year == 0 {
			year = date.StartYear
		}
	...
	case types.DateTypeBetween, types.DateTypeFromTo:
...
func placeComponentSimilarity(place1, place2 *types.GedcomPlace) float64 {
