...
func NewCrossReferenceValidator(errorManager *types.ErrorManager) *CrossReferenceValidator {
...
func (crv *CrossReferenceValidator) Validate(tree *types.GedcomTree) error {
...
func (crv *CrossReferenceValidator) validateCrossReferences(tree *types.GedcomTree) {
...
func (crv *CrossReferenceValidator) validateFamilyReferences(tree *types.GedcomTree) {
	families := tree.GetAllFamilies()
	individuals := tree.GetAllIndividuals()
...
func (crv *CrossReferenceValidator) validateIndividualReferences(tree *types.GedcomTree) {
	individuals := tree.GetAllIndividuals()
	families := tree.GetAllFamilies()
