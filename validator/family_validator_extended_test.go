...
func TestFamilyValidator_ValidateReferences_WIFE(t *testing.T) {
	...
	wifeLine := types.NewGedcomLine(1, "WIFE", "INVALID_FORMAT", "")
...
func TestFamilyValidator_ValidateReferences_CHIL(t *testing.T) {
	...
	famLine := types.NewGedcomLine(0, "FAM", "", "@F1@")
	husbLine := types.NewGedcomLine(1, "HUSB", "@I1@", "")
	chil1 := types.NewGedcomLine(1, "CHIL", "@I2@", "")
	chil2 := types.NewGedcomLine(1, "CHIL", "INVALID_FORMAT", "")
	famLine.AddChild(husbLine)
...
func TestFamilyValidator_ValidateEvents_MultipleDivorce(t *testing.T) {
	...
	famLine := types.NewGedcomLine(0, "FAM", "", "@F1@")
	husbLine := types.NewGedcomLine(1, "HUSB", "@I1@", "")
	div1 := types.NewGedcomLine(1, "DIV", "", "")
	div2 := types.NewGedcomLine(1, "DIV", "", "")
	famLine.AddChild(husbLine)
...
func TestFamilyValidator_ValidateEvents_AllEventTypes(t *testing.T) {
	...
	engaLine := types.NewGedcomLine(1, "ENGA", "", "")
	anulLine := types.NewGedcomLine(1, "ANUL", "", "")
	censLine := types.NewGedcomLine(1, "CENS", "", "")
...
func TestFamilyValidator_ValidateStructure_OnlyWife(t *testing.T) {
	...
	famLine := types.NewGedcomLine(0, "FAM", "", "@F1@")
	wifeLine := types.NewGedcomLine(1, "WIFE", "@I1@", "")
	famLine.AddChild(wifeLine)
	famRecord := types.NewFamilyRecord(famLine)
	tree.AddRecord(famRecord)
