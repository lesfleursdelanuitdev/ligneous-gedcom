...
func NewIndividualValidator(errorManager *types.ErrorManager) *IndividualValidator {
	validTags := map[string]bool{
...
func (iv *IndividualValidator) Validate(tree *types.GedcomTree) error {
...
func (iv *IndividualValidator) validateIndividual(xrefID string, record types.Record) {
...
func (iv *IndividualValidator) validateStructure(xrefID string, record types.Record) {
...
func (iv *IndividualValidator) validateReferences(xrefID string, record types.Record) {
...
func (iv *IndividualValidator) validateSex(xrefID string, record types.Record) {
...
func (iv *IndividualValidator) validateEvents(xrefID string, record types.Record) {
...
func (iv *IndividualValidator) validateEventStructure(xrefID, eventTag string, eventLine *types.GedcomLine) {
...
func (iv *IndividualValidator) validateNames(xrefID string, record types.Record) {
	nameLines := record.GetLines("NAME")

	if len(nameLines) == 0 {
		iv.AddError(types.SeveritySevere,
...
func (iv *IndividualValidator) validateNameStructure(xrefID string, nameLine *types.GedcomLine) {
