...
func (dd *DuplicateDetector) buildBlockIndex(individuals []*gedcom.IndividualRecord) *BlockIndex {
	index := NewBlockIndex()
...
func (dd *DuplicateDetector) computePersonBlock(id uint32, indi *gedcom.IndividualRecord) PersonBlock {
	block := PersonBlock{
		ID:         id,
		Individual: indi,
	}
...
func (dd *DuplicateDetector) generateBlockedComparisonJobs(individuals []*gedcom.IndividualRecord) ([]comparisonJob, *BlockingMetrics) {
	// Build block index
