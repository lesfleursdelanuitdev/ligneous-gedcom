...
func (dd *DuplicateDetector) calculateRelationshipSimilarity(indi1, indi2 *gedcom.IndividualRecord) float64 {
	if dd.tree == nil {
		return 0.0
	}
...
func getParents(indi *gedcom.IndividualRecord, tree *gedcom.GedcomTree) []string {
...
func getSpouses(indi *gedcom.IndividualRecord, tree *gedcom.GedcomTree) []string {
...
func getChildren(indi *gedcom.IndividualRecord, tree *gedcom.GedcomTree) []string {
